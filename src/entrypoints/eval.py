...
# ================= CẤU HÌNH TRỰC TIẾP =================
CKPT_PATH = "models/checkpoints/fs26/action_recognition/classification/v19.efficientv2s.for_CNN_8_classes_cut_left_4_frames+resagepar_gen_v1/weights/best-epoch=03-val_acc=0.396.ckpt"
# =====================================================
