...
INPUT_PATHS = [
    ...
    # "data/processed/fs26/action_recognition/classification/action.for_CNN.8_classes.manually_selected/cho_tay_vao_ke/train.txt"
]  # Path tới file ảnh, file .txt hoặc thư mục
DEVICE = "cuda:1"
BATCH_SIZE = 64
OUTPUT_DIR = "data/tmp/predict_2dcnn_action_saliency"
# =====================================================
